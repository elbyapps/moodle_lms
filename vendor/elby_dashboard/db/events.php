...
$observers = [
    ...
    [
        ...
        'callback'  => '\local_elby_dashboard\observer::course_created',
    ],
    [
        'eventname' => '\core\event\course_updated',
        'callback'  => '\local_elby_dashboard\observer::course_updated',
    ],
    [
        'eventname' => '\core\event\course_deleted',
        'callback'  => '\local_elby_dashboard\observer::course_deleted',
    ],
    [
        'eventname' => '\core\event\cohort_created',
        'callback'  => '\local_elby_dashboard\observer::cohort_created',
    ],
];
