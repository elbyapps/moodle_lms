...
$functions = [
    ...
    // Course form: searchable module lookup.
    'local_elby_dashboard_search_modules' => [
        'classname'    => 'local_elby_dashboard\external\module_search',
        'methodname'   => 'search',
        'description'  => 'Search curriculum modules (subjects) for the course form, optionally scoped to a trade',
        'type'         => 'read',
        'ajax'         => true,
        'capabilities' => 'local/elby_dashboard:view',
    ],
