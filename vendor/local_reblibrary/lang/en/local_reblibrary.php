...
$string['s3publicendpoint_desc'] = 'Browser-accessible HTTPS storage endpoint. All library assets download directly from here after Moodle authorisation, using signed URLs valid for 10 minutes; there is no PHP download proxy. Configure CORS for the exact Moodle origin: allow GET/HEAD and Range; expose Content-Range, Accept-Ranges, Content-Length and ETag. Validate PDF previews, saving files, cover images and video seeking before deployment.';
