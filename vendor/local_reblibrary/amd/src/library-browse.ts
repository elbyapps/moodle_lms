...
/**
 * Library browse page module with Preact integration.
 *
 * @module     local_reblibrary/library-browse
...
/**
 * Initialize the Library Browse Preact application.
 *
 * Reads resources, categories, and education structure data from HTML data attributes,
 * and renders the LibraryBrowse component.
 *
 * @param {string} selector - CSS selector for the mount point
 */
export const init = (selector: string = '#library-browse-root') => {
    ...
    try {
        ...
        console.log('Library browse data loaded:', {
        ...
        console.error('Error parsing library browse data attributes:', error);
    }
};
