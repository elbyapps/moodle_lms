...
/**
 * Elby Dashboard RISE recruitment page.
 *
...
// Check capability. RISE is a reports-level view.
require_capability('local/elby_dashboard:viewreports', $context);

$PAGE->set_url(new moodle_url('/local/elby_dashboard/rise.php'));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('page_title', 'local_elby_dashboard') . ' - ' . get_string('rise', 'local_elby_dashboard'));
...
$PAGE->add_body_class('local-elby-dashboard-rise');
...
$PAGE->navbar->add(get_string('rise', 'local_elby_dashboard'));
...
$themeconfig = [
    ...
    'menuVisibility' => [
        ...
        'rise' => has_capability('local/elby_dashboard:viewreports', $context),
